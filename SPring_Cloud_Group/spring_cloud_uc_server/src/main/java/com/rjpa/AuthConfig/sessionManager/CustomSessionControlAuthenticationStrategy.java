...
public class CustomSessionControlAuthenticationStrategy extends ConcurrentSessionControlAuthenticationStrategy {
    ...
    public CustomSessionControlAuthenticationStrategy(CustomSessionRegistryImpl sessionRegistry) {
...
//                        ((CustomSessionRegistryImpl) sessionRegistry).addSessionInfo(CustomSessionRegistryImpl.SESSIONIDS, leastRecentlyUsed.getSessionId(), leastRecentlyUsed);
                        redisDao.addSessionInfo(CustomSessionRegistryImpl.SESSIONIDS, leastRecentlyUsed.getSessionId(), leastRecentlyUsed);
                        return;
                    }
    ...
    @Autowired
    private final CustomSessionRegistryImpl sessionRegistry;
}
